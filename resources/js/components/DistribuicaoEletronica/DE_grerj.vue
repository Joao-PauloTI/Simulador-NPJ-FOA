<template>
	<div>
		...
		<div class="container">
			...
			<p>
				Campos marcados com
				<strong>*</strong> são de preenchimento obrigatório.
			</p>
			<div class="card">
				<div class="card-header">
					<h5>
				...
				<div class="card-body">
					...
					<div v-show="showOpcao === 'showNao'">
						<br />
						<label for="grerjMotivo">
							<strong>* Motivo</strong>
							<select name="p_grerjMotivo" id="grerjMotivo" class="custom-select">
								<option value>Escolha um motivo</option>
								<option value="Juizado Especial Cível">Juizado Especial Cível</option>
								<option
									value="Justiça Gratuita / Pedido de Gratuidade"
								>Justiça Gratuita / Pedido de Gratuidade</option>
							</select>
						</label>
					</div>
				</div>
