	...
	<div class="container">
		...
		<div class="card">
			<div class="card-header">
				<h5>
					<strong>Upload do(s) Anexo(s) da Petição Inicial</strong>
			...
			<div class="card-body">
				<div class="container">
					...
					<div>
						...
						<p
							style="color: red"
						>Para adicionar mais de um arquivo, basta segurar a tecla Ctrl e selecionar os arquivos. Após selecioná-los, clique no botão "Enviar".</p>
					</div>
					<br />
					<div align="center">
						<button
...
export default {
	...
	methods: {
		...
		receberNomeDocumento: function() {
			this.anexosPeticao = document.getElementById(
				"escolherAnexoPeticaoId"
			).files;
		},
