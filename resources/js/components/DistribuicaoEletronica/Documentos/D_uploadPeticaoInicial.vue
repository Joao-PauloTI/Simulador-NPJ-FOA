...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="container">
                <div>
                    <label for="escolherPeticaoInicialId" class="btn btn-primary">Procurar</label>
                    <input type="file" name="dpi_arquivo" id="escolherPeticaoInicialId" v-on:change="receberNomeDocumento" style="display: none">
                    <span style="margin-left: 10px">{{nomePeticaoInicial}}</span>
                </div>
                <br>
                <div>
                    <span><strong>* Descrição </strong> </span>
                    <input type="text" name="dpi_descricao" class="form-control" required>
