	...
	<div class="container">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<a
					...
					v-if="deRepresentanteAutor.length < 1"
				>Cadastrar Representante do Autor</a>
				<a
					href="#"
					data-toggle="modal"
					data-backdrop="static"
					...
					data-target="#representanteAutorModal"
					v-else
				>Alterar Representante do Autor</a>
				...
				<div v-if="deAutor != null || deRepresentanteAutor != null">
					<table class="table table-borderless">
						<tr v-for="autor in deAutor">
							...
							<td>
								<a href="#" @click="excluirAutor">Excluir</a>
							</td>
						</tr>
						<tr v-for="representante in deRepresentanteAutor">
							...
							<td>
								<input
									type="text"
									name="ra_pessoa"
									v-bind:value="representante.raPessoa"
									readonly
									v-autowidth="{maxWidth: '960px', minWidth: '20px', comfortZone: 0}"
									style="border: 0; outline: none"
								/>
							...
							<td>
								<input
									type="text"
									name="ra_nome"
									v-bind:value="representante.raNome"
									readonly
									v-autowidth="{maxWidth: '960px', minWidth: '20px', comfortZone: 0}"
									style="border: 0; outline: none"
								/>
							...
							<td>
								<a href="#" @click="excluirRepresentanteAutor">Excluir</a>
							</td>
						</tr>
					</table>
				</div>
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<template v-if="deReuJuridico.length > 0">
					<a
						href="#"
						onclick="alert('Ja há um réu (pessoa jurídica) cadastrado. Apenas 1 réu poderá ser cadastrado por processo!')"
					>Cadastrar Réu - Pessoa Física</a>
				</template>
				<template v-else>
					<a
						href="#"
				...
				<template v-if="deReu.length > 0">
					<a
						href="#"
						onclick="alert('Ja há um réu (pessoa física) cadastrado. Apenas 1 réu poderá ser cadastrado por processo!')"
					>Cadastrar Réu - Pessoa Jurídica</a>
				</template>
				<template v-else>
					<a
						href="#"
						...
						data-backdrop="static"
						data-keyboard="false"
						data-target="#reuJuridicoModal"
						v-if="deReuJuridico.length < 1"
					>Cadastrar Réu - Pessoa Jurídica</a>
					<a
						href="#"
						data-toggle="modal"
				...
				<a
					...
					v-if="deRepresentanteReu.length < 1"
				>Cadastrar Representante do Réu</a>
				<a
					href="#"
					data-toggle="modal"
					data-backdrop="static"
					...
					data-target="#representanteReuModal"
					v-else
				>Alterar Representante do Réu</a>
				...
				<div v-if="deReu != null || deReuJuridico != null || deRepresentanteReu != null">
					<table class="table table-borderless">
						<tr v-for="reu in deReu">
							...
							<td>
								<a href="#" @click="excluirReu">Excluir</a>
							</td>
						</tr>
						<tr v-for="reuJuridico in deReuJuridico">
							...
							<td>
								<input
									type="text"
									name="rj_nome"
									v-bind:value="reuJuridico.rjNome"
									readonly
									v-autowidth="{maxWidth: '960px', minWidth: '20px', comfortZone: 0}"
									style="border: 0; outline: none"
								/>
							...
							<td>
								<a href="#" @click="excluirReuJuridico">Excluir</a>
							</td>
						</tr>
						<tr v-for="representante in deRepresentanteReu">
							...
							<td>
								<input
									type="text"
									name="rr_pessoa"
									v-bind:value="representante.rrPessoa"
									readonly
									v-autowidth="{maxWidth: '960px', minWidth: '20px', comfortZone: 0}"
									style="border: 0; outline: none"
								/>
							...
							<td>
								<input
									type="text"
									name="rr_nome"
									v-bind:value="representante.rrNome"
									readonly
									v-autowidth="{maxWidth: '960px', minWidth: '20px', comfortZone: 0}"
									style="border: 0; outline: none"
								/>
							...
							<td>
								<a href="#" @click="excluirRepresentanteReu">Excluir</a>
							</td>
						</tr>
					</table>
				</div>
		...
		<div class="card">
			...
			<div class="card-body">
				...
				>Enviar Comprovante de Residência</a>
				...
				>Upload do(s) Anexo(s) da Petição Inicial</a>
				...
				<div
					v-if="deNomePeticaoInicial != '' || deNomeCpf != '' || deNomeComprovanteResidencia != '' || deNomeProcuracao != '' || deNomeAnexoPeticao != null"
				>
					<table class="table table-borderless">
...
export default {
	...
	methods: {
		...
		adicionarRepresentanteAutor: function(
			raIncapaz,
			raMassa,
			raInsolvente,
			raPreso,
		...
		adicionarRepresentanteReu: function(
			rrParte,
			rrPessoa,
			rrSexo,
			rrCpf,
