...
export default {
    ...
    methods: {
        ajuda: function() {
            alert(
                "Dados de cadastro automático: \n\nAutor: Pessoa Física - CPF: 111.111.111-11 \nRepresentante do Autor: Pessoa Física - CPF: 222.222.222-22 \nRéu: Pessoa Física - CPF: 333.333.333-33 \nRéu: Pessoa Jurídica - CNPJ: 44.444.444/4444-44 \nRepresentante do Réu: Pessoa Física - CPF: 555.555.555.55")
        },
        //funções para o array deAutor
        adicionarAutor: function(aIncapaz, aMassa, aInsolvente, aPreso, aEspolio, aCondominio, aMinisterio, aPessoa, aEstrangeiro, aSexo, aCpf, aNome, aMenor, aDocumento, aNumeroIdentificacao, aExpedidor, aEmissao, aTelefone, aEmail, aRepresenta,
            aIntimacao, aCep, aEstado, aCidade, aBairro, aTipoLogradouro, aLogradouro, aNumeroEndereco, aComplemento, aTipoEndereco, aReferencia, aComprovante, aValorPedido, aValorLiquido, aValorCausa, aPretensao, aEstadoCivil, aProfissao,
            aNacionalidade, aEstadoNaturalidade, aCidadeNaturalidade, aPai, aMae, aNascimento) {
        ...
        adicionarRepresentanteAutor: function(raIncapaz, raMassa, raInsolvente, raPreso, raEspolio, raCondominio, raParte, raMinisterio, raPessoa, raSexo, raCpf, raNome, raDocumento, raNumeroIdentificacao, raEmissor, raEmissao, raTelefone, raEmail,
            raCep, raEstado, raCidade, raBairro, raTipoLogradouro, raLogradouro, raNumeroEndereco, raComplemento, raTipoEndereco, raReferencia, raComprovante, raEstadoCivil, raProfissao, raNacionalidade, raEstadoNaturalidade,
            raCidadeNaturalidade, raPai, raMae, raNascimento) {
        ...
        adicionarReu: function(rEstrangeiro, rSexo, rCpf, rNome, rDocumento, rNumeroIdentificacao, rExpedidor, rEmissao, rEmail, rIncerto, rCep, rEstado, rCidade, rBairro, rTipoLogradouro, rLogradouro, rNumeroEndereco, rComplemento, rTipoEndereco,
            rReferencia, rComprovante) {
        ...
        adicionarRepresentanteReu: function(rrParte, rrPessoa, rrSexo, rrCpf, rrNome, rrMenor, rrDocumento, rrNumeroIdentificacao, rrEmissor, rrEmissao, rrTelefone, rrEmail, rrIncerto, rrCep, rrEstado, rrCidade, rrBairro, rrTipoLogradouro,
            rrLogradouro, rrNumeroEndereco, rrComplemento, rrTipoEndereco, rrReferencia, rrComprovante) {
