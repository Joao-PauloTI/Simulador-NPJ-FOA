	...
	<div class="container">
		<div class="card">
			...
			<div class="card-body">
				<div>
					...
					<div class="custom-control custom-control-inline custom-checkbox">
						<input
							...
							name="p_prioridadeDeficiente"
							value="Prioridade p/ deficiente físico ou mental"
							id="DE_dDP1"
						/>
						<label class="custom-control-label" for="DE_dDP1">Prioridade p/ deficiente físico ou mental</label>
					</div>
					<div class="custom-control custom-control-inline custom-checkbox">
						<input
							type="checkbox"
					...
					<div class="custom-control custom-control-inline custom-checkbox">
						<input
							type="checkbox"
							class="custom-control-input"
							name="p_prioridadePortador"
							value="Prioridade p/ portador de doença grave"
							id="DE_dDP3"
						/>
						<label class="custom-control-label" for="DE_dDP3">Prioridade p/ portador de doença grave</label>
					</div>
					<div class="custom-control custom-control-inline custom-checkbox">
						<input
							type="checkbox"
				...
				<div
					v-show="showComarca !== '' && (showCompetencia === 'Cível' || showCompetencia === 'Empresarial' || showCompetencia === 'Família' || showCompetencia === 'Fazenda Pública' || showCompetencia === 'Órfãos e Sucessões')"
				>
					<div class="custom-control custom-control-inline custom-checkbox">
						<input
							type="checkbox"
							name="p_conciliacao"
							value="Autor opta pela realização de audiência de
                            conciliação ou de mediação"
							class="custom-control-input"
							id="opcaoExtra"
						/>
						<label class="custom-control-label" for="opcaoExtra">
				...
				<div>
					<label for="DE_dDP_classe">
						...
						<select
							...
							id="DE_dDP_classe"
							v-model="showClasse"
							v-show="showCompetencia === 'Acidentes de Trabalho' && showComarca !== ''"
						>
							<option value>Escolha uma classe</option>
							...
							<option
								value="Embargos à Execução (por Título Judicial, Contra a Fazenda Pública
                                e Carta Precatória)"
							>
							...
							<option
								value="Execução de Título Extrajudicial contra a Fazenda Pública"
							>Execução de Título Extrajudicial contra a Fazenda Pública</option>
						...
						<select
							...
							id="DE_dDP_classe"
							v-model="showClasse"
							v-show="showCompetencia === 'Cível' && showComarca !== ''"
						>
							<option value>Escolha uma classe</option>
							<option value="Ação Civil Coletiva">Ação Civil Coletiva</option>
							<option value="Ação Civil Pública">Ação Civil Pública</option>
							...
							<option
								value="Busca e Apreensão em Alienação Fiduciária"
							>Busca e Apreensão em Alienação Fiduciária</option>
							<option value="Consignação em Pagamento – CPC">Consignação em Pagamento – CPC</option>
							<option value="Cumprimento de Sentença">Cumprimento de Sentença</option>
							...
							<option
								value="Despejo por Falta de Pagamento cumulado com Cobranças"
							>Despejo por Falta de Pagamento cumulado com Cobranças</option>
							...
							<option
								value="Embargos à execução (por Título Judicial, Contra a Fazenda Pública e
                                Carta Precatória)"
							>
							...
							<option
								value="Falência de Empresários, Socied. Empresárias, Microempresas e Empresas
							...
							<option
								value="Insolvência Requerida pelo Devedor ou pelo Espólio"
							>Insolvência Requerida pelo Devedor ou pelo Espólio</option>
							<option value="Interdito Proibitório">Interdito Proibitório</option>
							<option value="Inventário">Inventário</option>
							<option
								value="Liquidação Provisória de Sentença pelo Procedimento Comum"
							>Liquidação Provisória de Sentença pelo Procedimento Comum</option>
							<option value="Mandado de Segurança – CPC">Mandado de Segurança – CPC</option>
						...
						<select
							...
							id="DE_dDP_classe"
							v-model="showClasse"
							v-show="showCompetencia === 'Dívida Ativa Estadual' && showComarca !== ''"
						>
							<option value>Escolha uma classe</option>
							<option value="Ação Civil Pública">Ação Civil Pública</option>
							<option value="Alvará Judicial – Lei 6858/80">Alvará Judicial – Lei 6858/80</option>
						...
						<select
							...
							id="DE_dDP_classe"
							v-model="showClasse"
							v-show="showCompetencia === 'Dívida Ativa Municipal' && showComarca !== ''"
						>
							<option value>Escolha uma classe</option>
							<option value="Alvará Judicial – Lei 6858/80">Alvará Judicial – Lei 6858/80</option>
							<option
						...
						<select
							...
							id="DE_dDP_classe"
							v-model="showClasse"
							v-show="showCompetencia === 'Empresarial' && showComarca !== ''"
						>
							<option value>Escolha uma classe</option>
							<option value="Ação Civil Coletiva">Ação Civil Coletiva</option>
							<option value="Ação Civil Pública">Ação Civil Pública</option>
							...
							<option value="Despejo por falta de pagamento">Despejo por falta de pagamento</option>
							<option
								value="Despejo por Falta de Pagamento Cumulado Com Cobrança"
							>Despejo por Falta de Pagamento Cumulado Com Cobrança</option>
							...
							<option
								value="Falência de Empresários, Socied. Empresárias, Microempresas e
							...
							<option value="Reintegração/Manutenção de Posse">Reintegração/Manutenção de Posse</option>
							<option
								value="Restituição de Coisa ou Dinheiro na Falência do Devedor
                                Empresário"
							>
						...
						<select
							...
							id="DE_dDP_classe"
							v-model="showClasse"
							v-show="showCompetencia === 'Família' && showComarca !== ''"
						>
							<option value>Escolha uma classe</option>
							<option
								value="Abertura, Registro e Cumprimento de Testamento"
							>Abertura, Registro e Cumprimento de Testamento</option>
							...
							<option value="Consignação em Pagamento – CPC">Consignação em Pagamento – CPC</option>
							<option
								value="Conversão de Separação Judicial em Divórcio"
							>Conversão de Separação Judicial em Divórcio</option>
							<option value="Cumprimento de Sentença">Cumprimento de Sentença</option>
							<option value="Cumprimento Provisório de Decisão">Cumprimento Provisório de Decisão</option>
							<option value="Cumprimento Provisório de Sentença">Cumprimento Provisório de Sentença</option>
							...
							<option value="Mandado de Segurança – CPC">Mandado de Segurança – CPC</option>
							<option
								value="Outros Procedimentos de Jurisdição Voluntária"
							>Outros Procedimentos de Jurisdição Voluntária</option>
						...
						<select
							...
							id="DE_dDP_classe"
							v-model="showClasse"
							v-show="showCompetencia === 'Fazenda Pública' && showComarca !== ''"
						>
							<option value>Escolha uma classe</option>
							<option value="Ação Civil Coletiva">Ação Civil Coletiva</option>
							<option
								value="Ação Civil de Improbidade Administrativa"
							>Ação Civil de Improbidade Administrativa</option>
							...
							<option
								value="Busca e Apreensão Com Alienação Fidunciária"
							>Busca e Apreensão Com Alienação Fidunciária</option>
							<option value="Consignação em Pagamento – CPC">Consignação em Pagamento – CPC</option>
							...
							<option value="Embargos à Execução Fiscal">Embargos à Execução Fiscal</option>
							<option
								value="Embargos à Execução Fiscal (com Título Extrajudicial, Contra a
						...
						<select
							...
							id="DE_dDP_classe"
							v-model="showClasse"
							v-show="showCompetencia === 'Juizado Especial Civil' && showComarca !== ''"
						>
							<option value>Escolha uma classe</option>
							<option value="Alvará Judicial Lei 6.858/80">Alvará Judicial Lei 6.858/80</option>
							<option value="Cumprimento de Sentença">Cumprimento de Sentença</option>
							...
							<option value="Monitória">Monitória</option>
							<option
								value="Procedimento do Juizado Especial Civil/Fazendário"
							>Procedimento do Juizado Especial Civil/Fazendário</option>
							<option value="Protesto – CPC">Protesto – CPC</option>
						</select>
						<!--Órfãos e Sucessões-->
						<select
							...
							id="DE_dDP_classe"
							v-model="showClasse"
							v-show="showCompetencia === 'Órfãos e Sucessões' && showComarca !== ''"
						>
							<option value>Escolha uma classe</option>
							<option
								value="Abertura, Registro e Cumprimento de Testamento"
						...
						<select
							...
							id="DE_dDP_classe"
							v-model="showClasse"
							v-show="showCompetencia === 'Registro Civil de Pessoas Naturais' && showComarca !== ''"
						>
							<option value>Escolha uma classe</option>
							...
							<option
								value="Retificação ou Suprimento ou Restauração do Registo Cível"
							>Retificação ou Suprimento ou Restauração do Registo Cível</option>
						</select>
						<!--Registro Público-->
						<select
							class="custom-select"
							...
							id="DE_dDP_classe"
							v-model="showClasse"
							v-show="showCompetencia === 'Registro Público' && showComarca !== ''"
						>
							<option value>Escolha uma classe</option>
							<option value="Cumprimento Provisório de Sentença">Cumprimento Provisório de Sentença</option>
							<option value="Cumprimento Provisório de Decisão">Cumprimento Provisório de Decisão</option>
							...
							<option
								value="Embargos à Execução Fiscal (com Título Extrajudicial, Contra
				...
				<!--Distribuição-->
				<div>
					<label for="DE_dDP_distribuicao">
						<strong>* Distribuição</strong>
						<select class="custom-select" name="p_distribuicao" id="DE_dDP_distribuicao">
							<option
								value
								v-if="showComarca === '' || showCompetencia === '' || showClasse === ''"
							>Escolha uma distribuição</option>
							<option
								value="Distribuidor de Angra dos Reis"
								v-else-if="showComarca === 'Angra dos Reis' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Angra dos Reis</option>
							<option
								value="Distribuidor de Paraty"
								v-else-if="showComarca === 'Paraty' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Paraty</option>
							<option
								value="Distribuidor de Barra do Piraí"
								v-else-if="showComarca === 'Barra do Piraí' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Barra do Piraí</option>
							<option
								value="Distribuidor de Rio das Flores"
								v-else-if="showComarca === 'Rio das Flores' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Rio das Flores</option>
							<option
								value="Distribuidor de Valença"
								v-else-if="showComarca === 'Valença' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Valença</option>
							<option
								value="Distribuidor de Barra Mansa"
								v-else-if="showComarca === 'Barra Mansa' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Barra Mansa</option>
							<option
								value="Distribuidor de Itatiaia"
								v-else-if="showComarca === 'Itatiaia' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Itatiaia</option>
							<option
								value="Distribuidor de Pinheiral"
								v-else-if="showComarca === 'Pinheiral' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Pinheiral</option>
							<option
								value="Distribuidor de Porto Real"
								v-else-if="showComarca === 'Porto Real' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Porto Real</option>
							<option
								value="Distribuidor de Quatis"
								v-else-if="showComarca === 'Quatis' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Quatis</option>
							<option
								value="Distribuidor de Resende"
								v-else-if="showComarca === 'Resende' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Resende</option>
							<option
								value="Distribuidor de Rio Claro"
								v-else-if="showComarca === 'Rio Claro' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Rio Claro</option>
							<option
								value="Distribuidor de Piraí"
								v-else-if="showComarca === 'Piraí' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Piraí</option>
							<option
								value="Distribuidor de Engenheiro Paulo de Frontin"
								v-else-if="showComarca === 'Engenheiro Paulo de Frontin' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Engenheiro Paulo de Frontin</option>
							<option
								value="Distribuidor de Mendes"
								v-else-if="showComarca === 'Mendes' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Mendes</option>
							<option
								value="Distribuidor de Miguel Pereira"
								v-else-if="showComarca === 'Miguel Pereira' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Miguel Pereira</option>
							<option
								value="Distribuidor de Paracambi"
								v-else-if="showComarca === 'Paracambi' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Paracambi</option>
							<option
								value="Distribuidor de Paty do Alferes"
								v-else-if="showComarca === 'Paty do Alferes' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Paty do Alferes</option>
							<option
								value="Distribuidor de Vassouras"
								v-else-if="showComarca === 'Vassouras' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Vassouras</option>
							<option
								value="Distribuidor de Areal"
								v-else-if="showComarca === 'Areal' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Areal</option>
							<option
								value="Distribuidor de Comendador Levy Gasparian"
								v-else-if="showComarca === 'Comendador Levy Gasparian' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Comendador Levy Gasparian</option>
							<option
								value="Distribuidor de Paraíba do Sul"
								v-else-if="showComarca === 'Paraíba do Sul' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Paraíba do Sul</option>
							<option
								value="Distribuidor de Sapucaia"
								v-else-if="showComarca === 'Sapucaia' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Sapucaia</option>
							<option
								value="Distribuidor de Três Rios"
								v-else-if="showComarca === 'Três Rios' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Três Rios</option>
							<option
								value="Distribuidor de Volta Redonda"
								v-else-if="showComarca === 'Volta Redonda' && showCompetencia != '' && showClasse != ''"
							>Distribuidor de Volta Redonda</option>
						</select>
					</label>
				</div>
				<br />
