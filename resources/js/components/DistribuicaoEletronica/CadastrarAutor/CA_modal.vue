						...
						<div>
							<div class="custom-control custom-control-inline custom-checkbox">
								<input
									...
									id="CA_dP7"
								/>
								<label class="custom-control-label" for="CA_dP7">
						...
						<div>
							<div class="custom-control custom-control-inline custom-checkbox">
								<input
									type="checkbox"
									class="custom-control-input"
									v-model="aEstrangeiro"
									name="a_estrangeiro"
									value="Estrangeiro e/ou brasileiro residente no exterior"
									id="CA_dP8"
								/>
								<label class="custom-control-label" for="CA_dP8">
						...
						<div>
							<div class="custom-control custom-control-inline custom-checkbox">
								<input
									...
									id="CA_dP9"
								/>
								<label class="custom-control-label" for="CA_dP9">
						...
						<div class="form-inline">
							<div class="col-xs-2">
								...
								<input
									type="text"
									class="form-control"
									v-model="aNumeroIdentificacao"
									name="a_numeroIdentificacao"
									v-if="aDocumento === ''"
									v-mask="'#################'"
								/>
								<input
									...
									v-model="aNumeroIdentificacao"
									name="a_numeroIdentificacao"
									v-else-if="aDocumento === 'Passaporte'"
									v-mask
								/>
								<input
									type="text"
									...
									v-model="aNumeroIdentificacao"
									name="a_numeroIdentificacao"
									v-else-if="aDocumento === 'Registro Geral'"
									v-mask="'##.###.###-#'"
								/>
								<input
									type="text"
									...
									v-model="aNumeroIdentificacao"
									name="a_numeroIdentificacao"
									v-else-if="aDocumento === 'Carteira Nacional de Habilitação'"
									v-mask="'###########'"
								/>
								<input
									type="text"
									...
									v-model="aNumeroIdentificacao"
									name="a_numeroIdentificacao"
									v-else-if="aDocumento === 'Carteira de Trabalho'"
									v-mask="'###.#####.##-#'"
								/>
								<input
									type="text"
			...
			<div class="card-body">
				<div class="container">
					<table
						...
						v-if="aAdvogadoRepresentanteDados != null || aDefensorRepresentanteDados != null"
					>
						<tr>
							<th>OAB / Matrícula</th>
							<th>Nome</th>
							...
							<td>
								<div class="custom-control custom-checkbox">
									<input
										...
										name="ad_representa[]"
										value="Sim"
										v-bind:id="advogado.arNumeroOAB"
										checked
									/>
							...
							<td>
								<div class="custom-control custom-checkbox">
									<input
										...
										name="dp_representa[]"
										value="Sim"
										v-bind:id="defensor.arMatricula"
										checked
									/>
				...
				<div class="container">
					...
					<div id="alinhado">
						...
						<div class="form-inline">
							<div class="col-xs-2">
								<span>
									<strong>* Valor Postulado</strong>
								</span>
								<input
									type="text"
									class="form-control"
									v-model="aValorPedido"
									name="a_valorPedido"
									v-money="'R$'"
								/>
							</div>
						...
						<div>
							<div class="custom-control custom-control-inline custom-checkbox">
								...
								<label
									class="custom-control-label"
									for="CA_vPC2"
								>A pretensão deduzida versa sobre obrigações vincendas?</label>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="form-inline">
							<div class="col-xs-2">
								...
								<input
									...
									class="form-control"
									placeholder="Estado"
									v-model="aEstadoNaturalidade"
									name="a_estadoNaturalidade"
								/>
								<input
									type="text"
									class="form-control"
									placeholder="Cidade"
									v-model="aCidadeNaturalidade"
									name="a_cidadeNaturalidade"
								/>
							</div>
						</div>
					</div>
