<template>
    <div>
        <div v-if="!mostrarMenu">
            <button id="PI_menu_botao" v-on:click="mostrarMenu = !mostrarMenu"><strong> >> </strong></button>
        </div>
        <div class="card" v-if="mostrarMenu">
            <div class="card-header">
                <button id="PI_menu_botao" v-on:click="mostrarMenu = !mostrarMenu" style="float: right;"><strong> << </strong></button> 
